...
- (void)initSubViews
{
    ...
    self.portraitView.image = [UIImage imageNamed:@"parking"];
    ...
    self.subtitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(kPortraitMargin * 2 + kPortraitWidth,  kTitleHeight, kTitleWidth, kTitleHeight + 20)];
